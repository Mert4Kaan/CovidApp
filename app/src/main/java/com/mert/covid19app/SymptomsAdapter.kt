...
import com.mert.covid19app.R
import com.mert.covid19app.Model

class SymptomsAdapter(var symptomslist: ArrayList<Model>):RecyclerView.Adapter<SymptomsAdapter.ViewHolder>() {
